...
const translations = {
    'ja': {
        ...
        'gallery-title': '施工実績',
        'gallery-item-1': '解体工事の様子',
        'gallery-item-2': '重機による作業',
        'gallery-item-3': '完了後の清掃',
    ...
    'pt': {
        ...
        'gallery-title': 'Histórico de Obras',
        'gallery-item-1': 'Cena de demolição',
        'gallery-item-2': 'Trabalho com máquinas pesadas',
        'gallery-item-3': 'Limpeza após conclusão',
